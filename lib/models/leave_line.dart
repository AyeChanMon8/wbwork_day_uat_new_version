...
class LeaveLine {
  ...
  @override
  String toString() => 'LeaveLine(date: $date, dayofweek: $dayofweek,distinct_shift: $distinct_shift, full: $full, first: $first,second: $second, start_date: $start_date,end_date: $end_date, this_day_hour_id: $this_day_hour_id, next_day_hour_id: $next_day_hour_id,resource_calendar_id: $resource_calendar_id, allow_full_edit: $allow_full_edit,allow_first_edit: $allow_first_edit, allow_second_edit: $allow_second_edit, message: $message,update_status: $update_status, employee_id: $employee_id)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is LeaveLine && o.date == date && o.dayofweek == dayofweek && o.distinct_shift == distinct_shift && o.full == full
     && o.first == first && o.second == second && o.start_date == start_date && o.end_date == end_date
     && o.this_day_hour_id == this_day_hour_id && o.next_day_hour_id == next_day_hour_id && o.resource_calendar_id == resource_calendar_id && o.allow_full_edit == allow_full_edit
     && o.allow_first_edit == allow_first_edit && o.allow_second_edit == allow_second_edit && o.message == message && o.update_status == update_status
     && o.employee_id == employee_id;
  }

  @override
  int get hashCode => date.hashCode ^ dayofweek.hashCode ^ distinct_shift.hashCode ^ full.hashCode ^
  first.hashCode ^ second.hashCode ^ start_date.hashCode ^ end_date.hashCode ^ this_day_hour_id.hashCode ^ next_day_hour_id.hashCode ^ resource_calendar_id.hashCode ^ allow_full_edit.hashCode
  ^ allow_first_edit.hashCode ^ allow_second_edit.hashCode ^ message.hashCode ^ update_status.hashCode ^ employee_id.hashCode;
}
