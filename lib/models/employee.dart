...
class Employee {
  ...
  Company? branch_id,
    ...
    return Employee(
      ...
      allow_attendance_report: allow_attendance_report ?? this.allow_attendance_report,
      allow_organization_chart: allow_organization_chart ?? this.allow_organization_chart,
      ...
      mobile_app_attendance: mobile_app_attendance ?? this.mobile_app_attendance,
      ...
      allow_maintenance_request: allow_maintenance_request ?? this.allow_maintenance_request,
      allow_plan_trip: allow_plan_trip ?? this.allow_plan_trip,
      allow_plan_trip_waybill: allow_plan_trip_waybill ?? this.allow_plan_trip_waybill,
      ...
      allow_employee_change: allow_employee_change ?? this.allow_employee_change,
      allow_purchase_order_approval: allow_purchase_order_approval ?? this.allow_purchase_order_approval,
      allow_employee_benefit: allow_employee_benefit ?? this.allow_employee_benefit,
  ...
  factory Employee.fromMap(Map<String, dynamic> map) {
    ...
    return Employee(
      ...
      allow_employee_change: map['allow_employee_change'],
  ...
  @override
  String toString() => 'Employee(id: $id, name: $name, image_128: $image_128, job_title: $job_title, department_id: $department_id, job_id: $job_id, work_location: $work_location, mobile_phone: $mobile_phone, work_email: $work_email, company_id: $company_id, parent_id: $parent_id, ssb_no: $ssb_no, ssb_issue_date: $ssb_issue_date, smart_card_no: $smart_card_no, fingerprint_id: $fingerprint_id, child_ids: $child_ids, allow_leave_report: $allow_leave_report, allow_leave_request: $allow_leave_request, allow_attendance_report: $allow_attendance_report, allow_organization_chart: $allow_organization_chart, allow_pms: $allow_pms, allow_payslip: $allow_payslip, allow_loan: $allow_loan, allow_calendar: $allow_calendar, allow_reward: $allow_reward, allow_warning: $allow_warning, allow_overtime: $allow_overtime, allow_approval: $allow_approval, mobile_app_attendance: $mobile_app_attendance, allow_travel_request: $allow_travel_request, allow_insurance: $allow_insurance, allow_expense_claim: $allow_expense_claim, allow_expense_report: $allow_expense_report, allow_document: $allow_document, allow_fleet_info: $allow_fleet_info, allow_maintenance_request: $allow_maintenance_request, allow_plan_trip: $allow_plan_trip, allow_plan_trip_waybill: $allow_plan_trip_waybill, allow_day_trip: $allow_day_trip, allow_out_of_pocket: $allow_out_of_pocket, allow_travel_expense: $allow_travel_expense, allow_employee_change: $allow_employee_change, allow_purchase_order_approval: $allow_purchase_order_approval, allow_employee_benefit: $allow_employee_benefit, branch_id: $branch_id)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is Employee && o.id == id && o.name == name && o.image_128 == image_128 &&
    o.job_title == job_title && o.department_id == department_id && o.job_id == job_id && o.work_location == work_location && o.mobile_phone == mobile_phone &&
    o.work_email == work_email && o.company_id == company_id && o.parent_id == parent_id && o.ssb_no == ssb_no && o.ssb_issue_date == ssb_issue_date &&
    o.smart_card_no == smart_card_no && o.fingerprint_id == fingerprint_id && o.child_ids == child_ids && o.allow_leave_report == allow_leave_report && o.allow_leave_request == allow_leave_request &&
    o.allow_attendance_report == allow_attendance_report && o.allow_organization_chart == allow_organization_chart && o.allow_pms == allow_pms && o.allow_payslip == allow_payslip && o.allow_loan == allow_loan &&
    o.allow_calendar == allow_calendar && o.allow_reward == allow_reward && o.allow_warning == allow_warning && o.allow_overtime == allow_overtime && o.allow_approval == allow_approval &&
    o.mobile_app_attendance == mobile_app_attendance && o.allow_travel_request == allow_travel_request && o.allow_insurance == allow_insurance && o.allow_expense_claim == allow_expense_claim &&
    o.allow_expense_report == allow_expense_report && o.allow_document == allow_document && o.allow_fleet_info == allow_fleet_info && o.allow_maintenance_request == allow_maintenance_request && o.allow_plan_trip == allow_plan_trip &&
    o.allow_plan_trip_waybill == allow_plan_trip_waybill && o.allow_day_trip == allow_day_trip && o.allow_out_of_pocket == allow_out_of_pocket && o.allow_travel_expense == allow_travel_expense && o.allow_employee_change == allow_employee_change &&
    o.allow_purchase_order_approval == allow_purchase_order_approval && o.allow_employee_benefit == allow_employee_benefit && o.branch_id == branch_id;
  }

  @override
  int get hashCode => id.hashCode ^ name.hashCode ^ image_128.hashCode ^ job_title.hashCode ^ department_id.hashCode
  ^ job_id.hashCode ^ work_location.hashCode ^ mobile_phone.hashCode ^ work_email.hashCode
  ^ company_id.hashCode ^ parent_id.hashCode ^ ssb_no.hashCode ^ ssb_issue_date.hashCode
  ^ smart_card_no.hashCode ^ fingerprint_id.hashCode ^ child_ids.hashCode ^ allow_leave_report.hashCode
  ^ allow_leave_request.hashCode ^ allow_attendance_report.hashCode ^ allow_organization_chart.hashCode ^ allow_pms.hashCode
  ^ allow_payslip.hashCode ^ allow_loan.hashCode ^ allow_calendar.hashCode ^ allow_reward.hashCode
  ^ allow_warning.hashCode ^ allow_overtime.hashCode ^ allow_approval.hashCode ^ mobile_app_attendance.hashCode
  ^ allow_travel_request.hashCode ^ allow_insurance.hashCode ^ allow_expense_claim.hashCode ^ allow_expense_report.hashCode
  ^ allow_document.hashCode ^ allow_fleet_info.hashCode ^ allow_maintenance_request.hashCode ^ allow_plan_trip.hashCode
  ^ allow_plan_trip_waybill.hashCode ^ allow_day_trip.hashCode ^ allow_out_of_pocket.hashCode ^ allow_travel_expense.hashCode
  ^ allow_employee_change.hashCode ^ allow_purchase_order_approval.hashCode ^ allow_employee_benefit.hashCode ^ branch_id.hashCode;
}
