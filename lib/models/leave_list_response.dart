...
class LeaveListResponse {
  ...
  double? duration_unpaid_leave
    ...
    return LeaveListResponse(
      ...
      duration_unpaid_leave: duration_unpaid_leave ?? this.duration_unpaid_leave,
    );
  }
  ...
  @override
  String toString() => 'LeaveListResponse(id: $id, employee_id: $employee_id,holiday_status_id: $holiday_status_id, start_date: $start_date,end_date: $end_date, duration: $duration,description: $description, attachment: $attachment,file_name: $file_name, state: $state,leave_line: $leave_line,create_date: $create_date, duration_unpaid_leave: $duration_unpaid_leave)';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is LeaveListResponse && o.id == id && o.employee_id == employee_id  && o.holiday_status_id == holiday_status_id && o.start_date == start_date
     && o.end_date == end_date && o.duration == duration  && o.description == description 
     && o.attachment == attachment && o.file_name == file_name && o.state == state 
     && o.leave_line == leave_line && o.create_date == create_date
     && o.duration_unpaid_leave == duration_unpaid_leave;
  }

  @override
  int get hashCode => id.hashCode ^ employee_id.hashCode ^ holiday_status_id.hashCode ^ start_date.hashCode
   ^ end_date.hashCode ^ duration.hashCode ^ description.hashCode ^ attachment.hashCode
   ^ attachment.hashCode ^ file_name.hashCode ^ state.hashCode ^ leave_line.hashCode ^ create_date.hashCode  ^ duration_unpaid_leave.hashCode;
}
