...
class RequestLine {
  ...
  @override
  String toString() => 'RequestLine(employee_id: $employee_id, email: $email,state: $state,remark_line: $remark_line,mail_sent: $mail_sent)';
  ...
  @override
  int get hashCode => employee_id.hashCode ^ email.hashCode ^ state.hashCode ^ remark_line.hashCode ^  mail_sent.hashCode;
}
